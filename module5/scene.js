...
$(function(){
	...
	var directionalLightColor = new THREE.Vector3(0.0,0.0,1.0);
	var spotLightColor = new THREE.Vector3(1.0,1.0,1.0)
	...
	//Color typed uniform. oh the customPhong has them already
    
	//THREE.js custom shaders uses THREE.ShaderMaterial
